 ...
 * @author Luca Tesei
 *
 * @param <E> il tipo di elmenti del multinsieme. Se un multinsieme deve
...
public interface Multiset<E> {
     ...
     *
     * @throws NullPointerException se {@code element} è null
     */
     ...
     *         possibilmente zero
     *
     * @throws IllegalArgumentException se {@code occurrences} è negativo, o
     * se questa operazione comporterebbe più di {@code Integer.MAX_VALUE}
     ...
     *
     * @throws IllegalArgumentException se questa operazione comporterebbe
     * più di {@code Integer.MAX_VALUE} occorrenze dell'elemento
     * @throws NullPointerException se {@code element} è null
     */
    void add(E element);
     ...
     *         possibilmente zero
     *
     * @throws IllegalArgumentException se {@code occurrences} è negativo
     * @throws NullPointerException se {@code element} è null
     */
    ...
    /**
     * Aggiunge o rimuove le occorrenze di un elemento in modo tale che
     * l'elemento raggiunga il numero di occorrenze desiderato.
     *
     * @param element l'elemento di cui aggiungere o togliere occorrenze
     * @param occurrences il numero desiderato di occorrenze dell'elemento
     * @return il numero di occorrenze dell'elemento prima dell'operazione;
     *         possibilmente zero
     *
     * @throws IllegalArgumentException se {@code count} è negativo
     * @throws NullPointerException se {@code element} è negativo
     */
    int setCount(E element, int occurrences);
     ...
     *         di un elemento {@code e} tale che {@code element.equals(e) == true}
     *
     * @throws NullPointerException se {@code element} è null
     */
