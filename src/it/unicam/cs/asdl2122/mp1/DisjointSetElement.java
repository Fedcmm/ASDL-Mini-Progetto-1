 ...
 * dall'interface {@link DisjointSets}.
 * 
...
public interface DisjointSetElement {
     ...
     * dipende dall'implementazione della interface {@link DisjointSets} e viene
     ...
     *         implementazione di {@link DisjointSets}
     */
    DisjointSetElement getRef1();

    /**
     * Cambia il riferimento 1 di questo elemento. Si veda la API del metodo
     * {@link DisjointSetElement#getRef1()}.
     * 
     * @param e il nuovo valore del riferimento 1
     ...
     * {@link DisjointSetElement#getRef2()}.
     * 
     * @param e il nuovo valore del riferimento 2
     * @throws NullPointerException se l'elemento passato è null
     */
     ...
     * associato dipende dall'implementazione della interface {@link DisjointSets} e
     ...
     * {@link DisjointSetElement#getNumber()}.
     * 
     * @param n il nuovo valore dell'intero associato
     */
