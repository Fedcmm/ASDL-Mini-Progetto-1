...
public interface DisjointSets {
     ...
     * 
     * @param e l'elemento da inserire nell'insieme creato
     *
     * @throws NullPointerException se l'elemento passato è null
     * @throws IllegalArgumentException se l'elemento passato è già presente
     * in uno degli insiemi disgiunti correnti
     */
     ...
     * l'elemento passato.
     * 
     * @param e l'elemento di cui cercare l'insieme disgiunto
     * @return l'elemento rappresentante dell'insieme disgiunto in cui
     *         attualmente si trova <code>e</code>
     *
     * @throws NullPointerException se l'elemento passato è null
     * @throws IllegalArgumentException se l'elemento passato non è presente
     ...
     * 
     * @param e1 un elemento del primo insieme da unire
     * @param e2 un elemento del secondo insieme da unire
     *
     ...
     * 
     * @param e l'elemento di cui si vuole ottenere l'insieme disgiunto di
     *          cui fa parte
     ...
     * certo elemento.
     * 
     * @param e l'elemento di cui si vuole ottenere la cardinalità
